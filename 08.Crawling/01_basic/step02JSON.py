...
실습단계
    ...
    3. json 객체로 변환 : json 파일로부터 read해서 json객체 확인

고려사항
    1. 한글 데이터 보호(인코딩)
    2. json 파일 생성시 해당 데이터 검증 필수
...
print(friends) # [{'f1': 1, 'name': '김혜경'}, {'f2': 2, 'name': '이이'}, {'f3': 3, 'name': '허준'}]
...
jsonData = json.dumps(friends, ensure_ascii=False, indent=2) #ident=2 >> 들여쓰기 맞춰라!
print(jsonData)
